      ...
      <div className="max-w-[700px] mx-auto">
        ...
        <div className="text-gray-600 leading-relaxed space-y-6">
          ...
          <section>
            ...
            <p className="text-sm">Paid plans are processed through Razorpay. Plans may be monthly or yearly. Downgrading limits access but does not delete stored content.</p>
          </section>
          <section>
